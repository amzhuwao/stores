-- Stores backup generated at 2026-04-21 07:26:41 UTC
...
-- ----------------------------
INSERT INTO `backup_history` (`backup_id`, `file_name`, `file_path`, `file_size_bytes`, `trigger_type`, `status`, `started_at`, `completed_at`, `initiated_by`, `error_message`, `created_at`) VALUES ('1', 'pending', '', '0', 'manual', 'failed', '2026-04-21 07:26:41', NULL, '1', NULL, '2026-04-21 09:26:41');
...
-- ----------------------------
INSERT INTO `backup_settings` (`setting_id`, `is_enabled`, `frequency`, `run_time`, `day_of_week`, `day_of_month`, `retention_days`, `schedule_token`, `last_run_at`, `next_run_at`, `updated_by`, `updated_at`) VALUES ('1', '0', 'daily', '02:00:00', '1', '1', '30', 'f1dc44cfc702427899fd9edb082580a84918a99d45a2f96e', NULL, NULL, NULL, '2026-04-21 09:25:58');
...
-- ----------------------------
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('1', 'Food Items', 'Cooking ingredients and food', 'active', '2026-04-20 10:28:52');
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('2', 'Beverages', 'Drinks and beverage supplies', 'active', '2026-04-20 10:28:52');
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('3', 'Cleaning Supplies', 'Cleaning and maintenance chemicals', 'active', '2026-04-20 10:28:52');
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('4', 'Utensils & Equipment', 'Kitchen utensils and equipment', 'active', '2026-04-20 10:28:52');
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('5', 'Linen & Fabric', 'Bed linen and fabric items', 'active', '2026-04-20 10:28:52');
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('6', 'Tools & Hardware', 'Maintenance tools and hardware', 'active', '2026-04-20 10:28:52');
INSERT INTO `categories` (`category_id`, `category_name`, `description`, `status`, `created_at`) VALUES ('7', 'Packaging Materials', 'Boxes, bags, and packaging', 'active', '2026-04-20 10:28:52');
...
-- ----------------------------
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `head_user_id`, `status`, `monthly_budget`, `weekly_budget`, `created_at`) VALUES ('1', 'Kitchen', 'KIT', NULL, 'active', '0.00', '0.00', '2026-04-20 10:28:52');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `head_user_id`, `status`, `monthly_budget`, `weekly_budget`, `created_at`) VALUES ('2', 'Bar', 'BAR', NULL, 'active', '0.00', '0.00', '2026-04-20 10:28:52');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `head_user_id`, `status`, `monthly_budget`, `weekly_budget`, `created_at`) VALUES ('3', 'Housekeeping', 'HNK', NULL, 'active', '0.00', '0.00', '2026-04-20 10:28:52');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `head_user_id`, `status`, `monthly_budget`, `weekly_budget`, `created_at`) VALUES ('4', 'Maintenance', 'MNT', NULL, 'active', '0.00', '0.00', '2026-04-20 10:28:52');
INSERT INTO `departments` (`dept_id`, `dept_name`, `dept_code`, `head_user_id`, `status`, `monthly_budget`, `weekly_budget`, `created_at`) VALUES ('5', 'Front Office', 'FRO', NULL, 'active', '0.00', '0.00', '2026-04-20 10:28:52');
...
-- Records of `products`
-- ----------------------------
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('1', 'Cooking Oil - 5L', 'OIL-001', '1', 'Liters', '10', '50', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('2', 'Salt - 1KG', 'SAL-001', '1', 'KG', '5', '20', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('3', 'Sugar - 1KG', 'SUG-001', '1', 'KG', '5', '20', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('4', 'Flour - 1KG', 'FLO-001', '1', 'KG', '10', '50', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('5', 'Red Wine - 750ml', 'WIN-001', '2', 'Bottles', '20', '100', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('6', 'Beer - 330ml', 'BEE-001', '2', 'Bottles', '30', '150', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('7', 'Floor Cleaner - 5L', 'CLN-001', '3', 'Liters', '5', '20', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('8', 'Disinfectant - 1L', 'DIS-001', '3', 'Liters', '10', '30', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('9', 'Chef Knife', 'KNF-001', '4', 'Pieces', '3', '10', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('10', 'Bed Sheets - Queen', 'BED-001', '5', 'Pieces', '10', '30', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('11', 'Hand Soap - 500ml', 'SOP-001', '3', 'Bottles', '15', '50', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
INSERT INTO `products` (`product_id`, `product_name`, `product_code`, `category_id`, `unit_of_measure`, `reorder_level`, `reorder_quantity`, `status`, `created_at`, `updated_at`) VALUES ('12', 'Wrench Set', 'WRN-001', '6', 'Set', '2', '5', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
...
-- Records of `roles`
-- ----------------------------
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('1', 'Admin', 'System administrator with full access', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('2', 'Storekeeper', 'Manages stock and inventory', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('3', 'Kitchen', 'Kitchen department', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('4', 'Bar', 'Bar department', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('5', 'Housekeeping', 'Housekeeping department', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('6', 'Maintenance', 'Maintenance department', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('7', 'Accounts', 'Accounts and cost tracking', '2026-04-20 10:28:51');
INSERT INTO `roles` (`role_id`, `role_name`, `description`, `created_at`) VALUES ('8', 'Manager', 'Store manager', '2026-04-20 10:28:51');
...
-- Records of `stores`
-- ----------------------------
INSERT INTO `stores` (`store_id`, `store_name`, `store_code`, `location`, `responsible_user_id`, `description`, `status`, `created_at`, `updated_at`) VALUES ('1', 'Kitchen Store', 'KIT001', 'Ground Floor Kitchen', NULL, 'Main kitchen storage', 'active', '2026-04-20 10:28:51', '2026-04-20 10:28:51');
INSERT INTO `stores` (`store_id`, `store_name`, `store_code`, `location`, `responsible_user_id`, `description`, `status`, `created_at`, `updated_at`) VALUES ('2', 'Bar Store', 'BAR001', 'Ground Floor Bar', NULL, 'Beverage and bar supplies', 'active', '2026-04-20 10:28:51', '2026-04-20 10:28:51');
INSERT INTO `stores` (`store_id`, `store_name`, `store_code`, `location`, `responsible_user_id`, `description`, `status`, `created_at`, `updated_at`) VALUES ('3', 'Housekeeping Store', 'HNK001', 'Basement', NULL, 'Cleaning and laundry supplies', 'active', '2026-04-20 10:28:51', '2026-04-20 10:28:51');
INSERT INTO `stores` (`store_id`, `store_name`, `store_code`, `location`, `responsible_user_id`, `description`, `status`, `created_at`, `updated_at`) VALUES ('4', 'Maintenance Store', 'MNT001', 'Basement', NULL, 'Tools and maintenance supplies', 'active', '2026-04-20 10:28:51', '2026-04-20 10:28:51');
...
-- Records of `users`
-- ----------------------------
INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `full_name`, `role_id`, `status`, `created_at`, `updated_at`) VALUES ('1', 'admin', 'admin@hotel.com', '$2y$10$j2.FKXRaipAUbSlYU1NhQOBNCN/3R3lcSmYjhujl/gfdQ7pUc9./e', 'System Admin', '1', 'active', '2026-04-20 10:28:52', '2026-04-20 10:29:06');
INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `full_name`, `role_id`, `status`, `created_at`, `updated_at`) VALUES ('2', 'storekeeper1', 'storekeeper@hotel.com', '8b3d9bca7c134a9190277204379941460eb33c39868309401f02fa8e0391d4a7', 'John Storekeeper', '2', 'active', '2026-04-20 10:28:52', '2026-04-20 10:28:52');
