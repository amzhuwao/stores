...
$isGlobalAdjustmentRole = in_array($roleName, ['Admin', 'Manager', 'Storekeeper'], true);
...
$adjustments = $controller->getAdjustments($filters, $currentUserId);
