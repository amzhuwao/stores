...
$isGlobalRequisitionRole = in_array($roleName, ['Admin', 'Manager', 'Storekeeper'], true);
...
$requisitions = $controller->getRequisitions($filters, $currentUserId);
    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <?php if ($isGlobalRequisitionRole): ?>
                ...
                <?php elseif (count($departments) === 1): ?>
                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($departments[0]['dept_name']); ?>" readonly>
                    <input type="hidden" name="department_id" value="<?php echo (int)$departments[0]['dept_id']; ?>">
                <?php else: ?>
                    <select name="department_id" class="form-control">
