        ...
        <form method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <select name="department_id" class="form-control" required>
                        ...
                        <?php foreach ($departments as $department): ?>
                            <option value="<?php echo (int)$department['dept_id']; ?>" <?php echo ((string)$formData['department_id'] === (string)$department['dept_id']) ? 'selected' : ''; ?>>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" value="<?php echo htmlspecialchars(getCurrentUser()['full_name'] ?? ''); ?>" readonly>
                </div>
                <div class="col-md-12">
