...
$supplier = $controller->getById($supplierId);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!Security::verifyCSRFToken($token)) {
        ...
        $result = $controller->update($supplierId, $formData);
        if ($result['success']) {
...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1>Edit Supplier</h1>
        <p>Update supplier contact and commercial details.</p>
    </div>
...
<div class="card">
    <div class="card-header">
        <h5><i class="fas fa-edit"></i> Supplier Details</h5>
    </div>
    <div class="card-body">
        <?php if (!empty($error)): ?>
